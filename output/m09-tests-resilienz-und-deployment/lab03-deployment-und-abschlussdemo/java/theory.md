...
# Lab 3 (Java-Spur): Deployment-Strategien, DevOps und Abschlussdemonstration
...
- **Continuous Integration (CI)** baut und testet bei jeder Codeänderung automatisiert - eure `OrderControllerTest`- und `OrderEventPublisherTest`-Klassen wären typische CI-Bausteine.
