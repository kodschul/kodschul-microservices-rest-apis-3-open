...
# Lab 1 (Python-Spur): Docker-Compose-Datei erstellen
...
- `RABBITMQ_HOST: rabbitmq` nutzt den **Servicenamen** `rabbitmq` als Hostnamen - dieselbe Umgebungsvariable, die ihr in Modul 7 bereits konfigurierbar gemacht habt.
